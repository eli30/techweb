				...
				<?php
					...
					if(!empty($instance['twitter_link'])) { ?>
						<li class="spnc-service-wrap">
							<a class="spnc-service-link spnc-twitter" href="<?php echo esc_url($instance['twitter_link']); ?>" <?php if(!empty($instance['twitter_target'])){ echo "target='_blank'"; } ?> >
					...
					if(!empty($instance['facebook_link'])) { ?>
						<li class="spnc-service-wrap">
							<a class="spnc-service-link spnc-facebook" href="<?php echo esc_url($instance['facebook_link']); ?>" <?php if(!empty($instance['facebook_target'])){ echo "target='_blank'"; } ?> >
					...
					if(!empty($instance['instagram_link'])) { ?>
						<li class="spnc-service-wrap">
							<a class="spnc-service-link spnc-instagram" href="<?php echo esc_url($instance['instagram_link']); ?>" <?php if(!empty($instance['instagram_target'])){ echo "target='_blank'"; } ?> >
					...
					if(!empty($instance['youtube_link'])) { ?>
						<li class="spnc-service-wrap">
							<a class="spnc-service-link spnc-youtube" href="<?php echo esc_url($instance['youtube_link']); ?>" <?php if(!empty($instance['youtube_target'])){ echo "target='_blank'"; } ?> >
					...
					if(!empty($instance['linkedin_link'])) { ?>
						<li class="spnc-service-wrap">
							<a class="spnc-service-link spnc-linkedin" href="<?php echo esc_url($instance['linkedin_link']); ?>" <?php if(!empty($instance['linkedin_target'])){ echo "target='_blank'"; } ?> >
					...
					if(!empty($instance['skype_link'])) { ?>
						<li class="spnc-service-wrap">
							<a class="spnc-service-link spnc-skype" href="<?php echo esc_url($instance['skype_link']); ?>" <?php if(!empty($instance['skype_target'])){ echo "target='_blank'"; } ?> >
					...
					if(!empty($instance['vimeo_link'])) { ?>
						<li class="spnc-service-wrap">
							<a class="spnc-service-link spnc-vimeo" href="<?php echo esc_url($instance['vimeo_link']); ?>" <?php if(!empty($instance['vimeo_target'])){ echo "target='_blank'"; } ?> >
					...
					if(!empty($instance['dribble_link'])) { ?>
						<li class="spnc-service-wrap">
							<a class="spnc-service-link spnc-dribbble" href="<?php echo esc_url($instance['dribble_link']); ?>" <?php if(!empty($instance['dribble_target'])){ echo "target='_blank'"; } ?> >
