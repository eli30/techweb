                ...
                { 
					foreach($newscrunch_social_icon_data as $newscrunch_social)
                  	{ 
	                    ...
	                    $newscrunch_a = isset($newscrunch_exp[1]);
	                    if(!empty($newscrunch_social_icon)):?>
		                    <li>
		                      <a class="<?php echo $newscrunch_a; ?>" <?php if($newscrunch_social->open_new_tab== 'yes'){echo "target='_blank'";} ?> href="<?php echo $newscrunch_social_link; ?>" alt="<?php echo $newscrunch_a; ?>"><i class="<?php echo $newscrunch_social_icon; ?>"></i></a>
		                    </li>
				     	<?php endif;
			    	} 
			    } ?>
