...
function newscrunch_bottom_footer_panel_customizer ( $wp_customize ) {
    ...
    $wp_customize->add_setting('footer_copyright', 
        array(
            'default'           =>  __('Proudly powered by', 'newscrunch' ) . ' ' . '<a href="https://wordpress.org">' . 'WordPress' . '</a>' . ' | ' . __("Theme","newscrunch") .': Newscrunch ' . __("by", "newscrunch") . ' ' . '<a href="https://spicethemes.com" rel="nofollow">' . 'Spicethemes' . '</a>',
