...
function newscrunch_fallback_page_menu($args = array()) {
    ...
    if ($menu)
        if(get_theme_mod('header_layout','default')=='2' || get_theme_mod('header_layout','default')=='3' || get_theme_mod('header_layout','default')=='4' || get_theme_mod('header_layout','default')=='5' || get_theme_mod('header_layout','default')=='6') {
