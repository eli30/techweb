...
function newscrunch_color_back_custom_css() {
    ...
    $newscrunch_enable_theme_footer_color          =   get_theme_mod('hide_show_theme_footer_color', true);
            ...
            { ?>
                <style type="text/css">
                    body.newscrunch #page .spnc-cat-links a.newscrunch_category_<?php echo esc_attr($term->slug);?>
                        {
                            background: <?php echo esc_attr( get_theme_mod('newscrunch_category_'.$term->slug, '#ff495c') ); ?>;
                        }
                    body .spnc-category-page .spnc-blog-cat-wrapper .spnc-first-catpost .spnc-cat-links a.newscrunch_category_<?php echo esc_attr($term->slug); ?>
                            {
                                color: <?php echo esc_attr( get_theme_mod('newscrunch_category_'.$term->slug, '#ff495c') ); ?>;
                            }
                </style>
            <?php
        }
    ...
    if( ($hide_show_header_border == true )  && ( $hide_show_header_border_radius == false)) { ?>
        <style type="text/css">
            .header-1 .spnc-custom .spnc-navbar {margin: 1px 1px;}
        </style>
    <?php } 
