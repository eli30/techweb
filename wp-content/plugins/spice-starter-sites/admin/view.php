                        ...
                        <div class="sss-card" >
                            ...
                            <div class="sss-card-details">
                                ...
                                <div class="sss-card-btn">
                                    <a href="<?php echo esc_url($spice_starter_sites_importer_target['demo_link']);?>" class="sss-preview">Preview</a>
                    ...
                    <div class="sss-content-section sss-starter-pack pro">
                        <div class="sss-card" >
                            ...
                            <div class="sss-card-details">
                                ...
                                <div class="sss-card-btn">
                                    <a href="<?php echo esc_url($spice_starter_sites_importer_pro_target['demo_link']);?>" class="sss-preview">Preview</a>
        ...
        <div align="center">
            ...
            if($theme->name==='Newscrunch'){?>
                ...
                <div align="justify" class="block-container">
                    ...
                    <p><?php esc_html_e('Spice Starter Sites Importer is a plugin that provides a demo import feature with one click. It is compatible with News Crunch. We need to follow instructions for better results.','spice-starter-sites');?></p>
                    </div>
                    ...
                    <ol>
                        ...
                        <li><?php esc_html_e('After that activate News Crunch theme.', 'spice-starter-sites');?></li>
                        <li><?php esc_html_e('After that activate the News Crunch theme and also activated all recommended plugins.', 'spice-starter-sites');?></li>
